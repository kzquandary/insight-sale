                        ...
                        <div class="accordion-body">
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <select class="select" id="id_produk">
                                            ...
                                            <option value="{{ $item->id }}" {{ $item->id == $penjualan->id_produk ? 'selected' : '' }}>{{ $item->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Jumlah</label>
                                        <input value="{{ $penjualan->jumlah }}" type="number" id="jumlah" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Tanggal</label>
                                        <input value="{{ $penjualan->tanggal }}" type="date" id="tanggal" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
